  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative h-svh w-[--sidebar-width] bg-red-500 transition-[width] duration-200 ease-linear",
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col text-white bg-gradient-to-r from-violet-600 to-indigo-600 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
