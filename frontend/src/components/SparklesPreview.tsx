...
export function SparklesPreview({heading}:SparklePreviewProps) {
  return (
    <div className="h-52 w-full bg-transparent flex flex-col items-center justify-center overflow-hidden rounded-md">
